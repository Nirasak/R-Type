...
TEST(DyLib, get_function_bad_handler)
{
    try {
        DyLib lib(std::string("./dynlib") + std::string(DyLib::extension));
        lib.close();
...
TEST(DyLib, get_function_bad_symbol)
{
    try {
        DyLib lib(std::string("./dynlib") + std::string(DyLib::extension));
...
TEST(DyLib, get_variable_bad_handler)
{
    try {
        DyLib lib(std::string("./dynlib") + std::string(DyLib::extension));
        lib.close();
...
TEST(DyLib, get_variable_bad_symbol)
{
    try {
        DyLib lib(std::string("./dynlib") + std::string(DyLib::extension));
